...
public class Address
{
    ...
    [Required, MinLength(2, ErrorMessage = "Please use a Name bigger than 3 letters"), MaxLength(100, ErrorMessage = "Please use a Name less than 100 letters")]
...
[Required, MinLength(3, ErrorMessage = "Please use a City bigger than 3 letters"), MaxLength(50, ErrorMessage = "Please use a City less than 50 letters")]
    ...
    [Required, RegularExpression(@"^([0-9]{6})$", ErrorMessage = "Please use a valid Postal Code with 6 numbers.")]
